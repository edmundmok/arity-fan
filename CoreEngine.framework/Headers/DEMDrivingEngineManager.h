...
/**
 * @brief Sets the arity credentials.
 * @param userId as string
 * @param deviceId as string
 * @param scopeToken as string
 * @note If enabledWebservice is set to 'true'; arity credentials are mandatory.
 * @return 'true' if the credentials are set, 'false' otherwise.
 */
- (BOOL)setArityCredentialsWithUserId:(NSString *)userId deviceId:(NSString *)deviceId scopeToken:(NSString *)scopeToken;
